...
public class NumberedUndirectedGraph extends ANumberedGraph {

	/* Loop counts as 2 here */
	public NumberedUndirectedGraph(int num) {
		super(num);
	}
	...
	public ANumberedGraph copy() {
		NumberedUndirectedGraph g = new NumberedUndirectedGraph(maxVertex);
		g.adjMatrix = new int[maxVertex][maxVertex];
	...
	public LinkedList<Integer> getEulerCircuit() {
		...
		NumberedUndirectedGraph graph2 = (NumberedUndirectedGraph) copy();
		int i = 0;
		circuit.add(0);
